  ...
  return (
    <div className="container">
      <div className="border border-3 p-4 custom-border">
        ...
        <iframe width="560" height="315" src="https://www.youtube.com/embed/Y6ZFQQC7rkk?si=GoxsNN8VZT3ejnhx" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
        ...
        <div className="key-features-section-header my-4">
